...
!   Enteros
    ...
    INTEGER :: iNumAR       !Number of Atecedent Rainfall values
    INTEGER :: iNumER       !Number of Event Rainfall values
!
!
!   Booleanas
	LOGICAL :: Stopping
...
!   Reales
	...
	REAL*8  :: dx			!Delta X
	REAL*8  :: dy			!Delta Y
	REAL*8  :: rMinAR       !Minimum Antecedent Rainfall
	REAL*8  :: rMaxAR       !Maximum Antecedent Rainfall
	REAL*8  :: rMinER       !Minimum Event Rainfall
	REAL*8  :: rMaxER       !Maximum Event Rainfall
   	REAL*8  :: rThres       !PoF threshold
!
!
!   Arrays
!
...
!   Reales
    ...
    REAL*8,   DIMENSION(:,:),		ALLOCATABLE :: samplingRes              !Results in the sampling matrix    
!
!
!	Structures
...
!   Texto
	...
	CHARACTER(LEN=2048) fname_sampler_dat        
